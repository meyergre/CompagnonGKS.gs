...
/**
 * Created by gregory on 24/09/13.
 */
public class Default {
    ...
    public static String URL_SEARCH = "https://gks.gs/sphinx/";
    public static String URL_TORRENT_GET = "https://gks.gs/get/"; // + ID
    public static String URL_TORRENT_SHOW = "https://gks.gs/torrent/"; // + ID
    public static String URL_PROFILE = "https://gks.gs/m/account/ratio";

    public static String Intent_startUpdate = "fr.lepetitpingouin.android.gks.INTENT.UPDATE.START";
